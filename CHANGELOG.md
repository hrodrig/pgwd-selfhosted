...
- **Repository `VERSION` 0.1.17** — README **Version** badge aligned.
- **Helm chart `pgwd`:** **`Chart.yaml`** **`version:`** **0.1.17**, **`appVersion`** **`v1.1.1`**, default **`image.tag`** **`v1.1.1`** — aligned with **[pgwd v1.1.1](https://github.com/hrodrig/pgwd/releases/tag/v1.1.1)** on GHCR (Go **1.26.6**, `golang.org/x/net` **v0.56.0**).
- **Compose / Ansible / docs:** **`PGWD_VERSION`**, **`run/common/.env.example`**, **`testing/platforms`** defaults, and README examples use **`v1.1.1`** as the documented application image tag.
...
- **Repository `VERSION` 0.1.12** — README **Version** badge aligned.
- **Helm chart `pgwd`:** **`Chart.yaml`** **`version:`** **0.1.12**, **`appVersion`** **`v0.6.10`**, default **`image.tag`** **`v0.6.10`** — aligned with **[pgwd v0.6.10](https://github.com/hrodrig/pgwd/releases/tag/v0.6.10)** on GHCR (Docker runtime **Alpine 3.24.1**; OpenSSL/CVE-2026-2673).
- **Compose / Ansible / docs:** **`PGWD_VERSION`**, **`run/common/.env.example`**, **`testing/platforms`** defaults, and README examples use **`v0.6.10`** as the documented application image tag.

## [0.1.11] - 2026-06-10

### Changed

- **Repository `VERSION` 0.1.11** — README **Version** badge aligned.
- **Helm chart `pgwd`:** **`Chart.yaml`** **`version:`** **0.1.11**, **`appVersion`** **`v0.6.8`**, default **`image.tag`** **`v0.6.8`** — aligned with **[pgwd v0.6.8](https://github.com/hrodrig/pgwd/releases/tag/v0.6.8)** on GHCR (Go **1.26.4** security patch: **GO-2026-5037**, **GO-2026-5039**).
- **Compose / Ansible / docs:** **`PGWD_VERSION`**, **`run/common/.env.example`**, **`testing/platforms`** defaults, and README examples use **`v0.6.8`** as the documented application image tag.

## [0.1.10] - 2026-06-01

### Changed

- **Repository `VERSION` 0.1.10** — README **Version** badge aligned.
- **Helm chart `pgwd`:** **`Chart.yaml`** **`version:`** **0.1.10**, **`appVersion`** **`v0.6.7`**, default **`image.tag`** **`v0.6.7`** — aligned with **[pgwd v0.6.7](https://github.com/hrodrig/pgwd/releases/tag/v0.6.7)** on GHCR (enriched **Notification sent** daemon log, **too_many_clients** locale fix).
- **Compose / Ansible / docs:** **`PGWD_VERSION`**, **`run/common/.env.example`**, **`testing/platforms`** defaults, and README examples use **`v0.6.7`** as the documented application image tag.

## [0.1.9] - 2026-05-25

### Changed

- **Repository `VERSION` 0.1.9** — README **Version** badge aligned.
- **Helm chart `pgwd`:** **`Chart.yaml`** **`version:`** **0.1.9**, **`appVersion`** **`v0.6.6`**, default **`image.tag`** **`v0.6.6`** — aligned with **[pgwd v0.6.6](https://github.com/hrodrig/pgwd/releases/tag/v0.6.6)** on GHCR (`golang.org/x/net` v0.55.0 / GO-2026-5026).
- **Compose / Ansible / docs:** **`PGWD_VERSION`**, **`run/common/.env.example`**, **`testing/platforms`** defaults, and README examples use **`v0.6.6`** as the documented application image tag.
...
[Unreleased]: https://github.com/hrodrig/pgwd-selfhosted/compare/v0.1.17...HEAD
[0.1.17]: https://github.com/hrodrig/pgwd-selfhosted/compare/v0.1.16...v0.1.17
...
[0.1.9]: https://github.com/hrodrig/pgwd-selfhosted/compare/v0.1.8...v0.1.9
