...
[![Version](https://img.shields.io/badge/version-0.1.9-blue)](https://github.com/hrodrig/pgwd-selfhosted/releases)
...
- **`Chart.yaml` → `appVersion`** — **pgwd** application / image line; align with [pgwd releases](https://github.com/hrodrig/pgwd/releases) when you bump the deployed image story (defaults in this repo track **v0.6.6**).
