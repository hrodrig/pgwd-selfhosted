...
- **pgwd** — **`PGWD_DB_URL`**, GHCR **`PGWD_VERSION`** (default **v1.1.1** in examples), optional Slack/Loki webhooks, interval / log level, optional **`PGWD_SQLITE_PATH`** / **`PGWD_HTTP_LISTEN`** / hysteresis env vars
