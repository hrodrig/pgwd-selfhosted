...
## Align with this repo’s default (`v0.6.7`)

**Self-hosted paths in this repository** default to the published **GHCR** image **`v0.6.7`**: **`PGWD_DB_URL`**, optional **Slack/Loki**, and **logs** for operational checks. **SQLite, `/metrics`, multi-DB YAML** — **[pgwd README](https://github.com/hrodrig/pgwd/blob/main/README.md)**.
